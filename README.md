...
## Security and PKI
  ...
  * [Extuno](https://extuno.com) - Supply-chain scanning for browser extensions and packages across 12 ecosystems (Chrome, Firefox, VS Code, JetBrains, npm, PyPI, WordPress and more). Diffs every version, runs static rules, and detonates the package in a segmented sandbox. Free tier includes 5 scans; the malicious-package database, extension and permission checkers, and the Chrome/Firefox companion are free with no account.
